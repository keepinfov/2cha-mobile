...
/**
 * AES-256-GCM AEAD implementation using Bouncy Castle
 * NIST SP 800-38D compliant
 */
class Aes256GcmCipher(key: ByteArray) : AeadCipher {

    override val name: String = "AES-256-GCM"

    private val keyParameter: KeyParameter
    private var destroyed = false

    init {
        require(key.size == Constants.CHACHA20_KEY_SIZE) { // Same key size (32 bytes)
